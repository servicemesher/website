...
![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxs8jrwxj30qo0f0dip.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxsexhquj30qo0f0n08.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxsiq2z5j30qo0f0grx.jpg)
...
![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxsmb5l9j30qo0f0q4s.jpg)
...
![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxsq62x9j30qo0f0ac4.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxstzrdqj30qo0f040q.jpg)
...
![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxsx61iuj30qo0f0wg9.jpg)
...
![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxszj2wkj30qo0f0abt.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxt3aatgj30qo0f0juh.jpg)

前面给大家介绍了蚂蚁金服主站的Service Mesh演进路线，期间谈到要实现现有应用的平滑迁移。今天的第二个内容，将给大家介绍平滑迁移实现中的几个关键做法。

![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxt72zxjj30qo0f0jse.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxt9dqbsj30qo0f00uq.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtcjj4wj30qo0f0jt1.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtezb6wj30qo0f0dh6.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxti92oij30qo0f0wg2.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtk2cbej30qo0f0ad5.jpg)

大家好，我是来自UC基础研发部的龙轼。 感谢小剑老师给我们介绍了蚂蚁和UC共建的Service Mesh的演进路线和实现平滑迁移的关键。

接下来由我来向大家分享下实现平滑迁移的关键中的DNS寻址方案的演进。

![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtlzs10j30qo0f0q4l.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxtnvgf0j30qo0f0gmq.jpg)

现在大家可以先来看下 SOA 架构下基于服务注册和服务发现的寻址。

我们可以看到图中的 SOA 其实是单进程多接口的，依赖于 SOA 的服务注册与服务发现的。

![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtovfoxj30qo0f0myc.jpg)
...
![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxtr32x9j30qo0f0gmy.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtt2236j30qo0f00tq.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxtx8cboj30qo0f0q3y.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxu1urkdj30qo0f0wf6.jpg)
...
![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxu6p6cgj30qo0f0q5b.jpg)
...
![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxubqi33j30qo0f0djp.jpg)
...
![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxuel9hoj30qo0f03zw.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxuhvylcj30qo0f0n35.jpg)

我们可以看下 CoreDNS 后端存储的接口，其实和我们之前对数据操作的接口是没有什么差别的。

![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxuk3x3zj30qo0f0go6.jpg)

目前 CoreDNS 的 DynAPI 还在主库代码没合并的状态。之后 DynAPI 这个项目会独立成一个插件项目。我们可以看下 CoreDNS 社区的 DynAPI 插件进展。

![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxumjxr1j30qo0f00vw.jpg)
...
![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxuoytkjj30qo0f0q4a.jpg)
...
![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxurlu6tj30qo0f0q46.jpg)

我们把 CoreDNS 的功能开发完了，上线的话很多人关注它的性能。 我们这边做了一个简单的性能测试，可以看出 CoreDNS 和 Bind DNS 这种现在比较通用的DNS的性能还是有点差距的。

![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxuu4eu0j30qo0f0tf3.jpg)

但是,我们通过上面的图可以看到在一定的QPS 下，CoreDNS 的延时是很低的。 我们可以看到所有的延时都落在4ms 之内。

![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxuwnsanj30qo0f0abw.jpg)

为了解决QPS的问题，我们通过 Kubernetes 的 HPA 给 CoreDNS 进行横向的扩展。

一开始我们只是通过CPU的维度给 CoreDNS 扩展，但发现波动有点大。 之后我们切换成通过QPS的维度来进行扩容。

![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxuz1c5ej30qo0f0gmc.jpg)

CoreDNS 将会在Kubernetes 1.13 之后成为 Kubernetes 的默认的DNS服务。我们将会紧跟社区实施我们的方案并且反馈给社区。

![](https://ws4.sinaimg.cn/large/006tNbRwly1fxoxv0youwj30qo0f0tbs.jpg)

我们再来看下我们后续的一些规划。

![](https://ws1.sinaimg.cn/large/006tNbRwly1fxoxv3cwjjj30qo0f075p.jpg)

可以看到我们的 DynAPI 其实在安全上还是有欠缺的。我们后续会把 HTTP 加强成 HTTPS 协议来增强 DynAPI 的安全性。

![](https://ws3.sinaimg.cn/large/006tNbRwly1fxoxv5rwbbj30qo0f0dik.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxv8070fj30qo0f0ab1.jpg)
...
![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxvatmutj30qo0f0whk.jpg)

![](https://ws2.sinaimg.cn/large/006tNbRwly1fxoxvdouf2j30qo0f0gnc.jpg)
