...
在2018年上半年，蚂蚁金服决定基于 Istio 订制自己的 ServiceMesh 解决方案，在6月底对外公布了 SOFAMesh，详情请见之前的文章: [大规模微服务架构下的Service Mesh探索之路](https://skyao.io/publication/service-mesh-explore/) 。
...
- 这个方案延续了Kubernetes和Istio的做法，保持了一致的方式方式，对用户提供了相同的体验
